...
%--------------------------------------
%TODO set monofont
%\usepackage{inconsolata} %Enable Inconsolata font. it enables only monofont.
%\usepackage{FiraMono}

\makeatletter % This change the monofont size for the text in the document. Objective: same size in listings and in the document for monofont.
